...
1. **Create a free [Vercel](https://vercel.com) account** (with your GitHub account for instance) and install the [command-line node interface](https://www.npmjs.com/package/vercel). 
...
6. Complete the spreadsheet file with your client application url
...
#### 1. Review the [vercel.json](../server/vercel.json) file to configure the api deployment
...
#### 2. [Test locally](https://vercel.com/docs/cli/dev) your api with the cli
    ...
    <img src="./img/5-vercel-dev-cli.png"/>


    You could check your api with Insomnia.

    <img src="./img/5-vercel-dev-insomnia.png"/>
...
* [Using Express.js with Vercel](https://vercel.com/docs/frameworks/backend/express)
